        ...
        <div className="p-4 sm:p-8 space-y-8 max-w-6xl mx-auto animate-in fade-in duration-700 pb-20">
            <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 bg-panel border border-foreground/10 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden group">
                ...
                <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div>
                        <h1 className="text-4xl font-black text-foreground tracking-tighter uppercase italic">Centro de Tareas</h1>
                        <p className="text-text-dim mt-1 font-bold uppercase text-[10px] tracking-[0.4em] opacity-40">Misiones Diarias y Recompensas</p>
                    </div>
                </div>
            ...
            <footer className="text-center pt-20 text-[10px] font-black uppercase tracking-[0.6em] text-text-dim opacity-25 flex items-center justify-center gap-4">
                <AlertCircle className="w-4 h-4" /> Task Registry Protocol v2.5
            </footer>
        </div>
    );
};
